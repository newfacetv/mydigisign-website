...
function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.feature-card, .pricing-card, .analytics-card, .step');
        ...
        <div class="loader-content">
            <div class="loader-logo">
                <div class="logo-text">
                    ...
                    <span class="logo-digisign">DigiSign</span>
                    <span class="logo-ai" style="color: var(--primary-black);">.AI</span>
                </div>
            </div>
...
// Testimonials Carousel (for future use)
